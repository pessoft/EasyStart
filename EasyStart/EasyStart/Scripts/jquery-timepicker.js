...
(function($) {
    $.hunterTimePicker = function(box, options) {
        ...
        function buildHourTpl() {
            ...
            //hour_html += '<li class="Hunter-clean"><input type="button" class="Hunter-clean-btn" id="Hunter_clean_btn" value="Очистить"></li>'
