...
const StockInteractionDescription = (() => {
    ...
    description[StockInteractionType.FullJoin] = `Применяются все акции условия которых выполняются.
                                                  Акции с типом вознаграждения "скидка" будут просуммированы.
    ...
    description[StockInteractionType.FullExclude] = `Применяется только 1 акция с наибольшей ценностью для клиента. Например одновременно
                                                     выполняются акция со скидкой в 10% и подарок стоимостью 300 lei. Клиент оформил
                                                     заказ на сумму 2000 lei, следовательно, скидка составит 200 lei.
                                                     200 lei < чем подарок стоимостью 300 lei, следовательно, применится только акция с подарком.`
